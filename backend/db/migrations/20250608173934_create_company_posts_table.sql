...
CREATE TABLE IF NOT EXISTS company_posts (
    ...
    ADD COLUMN IF NOT EXISTStitle VARCHAR(200) NOT NULL DEFAULT 'Untitled',
    content TEXT NOT NULL,
    images TEXT[] DEFAULT '{}',
    ADD COLUMN IF NOT EXISTS status VARCHAR(20) NOT NULL DEFAULT 'draft' CHECK (status IN ('draft', 'published', 'archived')),
    ADD COLUMN IF NOT EXISTS visibility VARCHAR(20) NOT NULL DEFAULT 'public' CHECK (visibility IN ('public', 'members_only')),
